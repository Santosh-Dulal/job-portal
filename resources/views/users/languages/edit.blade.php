       ...
       <h1>{{__('Add Language Information')}}</h1>
        <div class="row">
          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
            <form action="{{route('languages.update',[$languages->id])}}" method="post">@csrf @method('patch')
               ...
               <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="text" id="language" name="language" class="form-control" value="{{$languages->language}}" required>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" id="proficiency" name="proficiency" class="form-control" value="{{$languages->proficiency}}" required>
