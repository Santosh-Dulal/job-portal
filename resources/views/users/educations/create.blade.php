...
<section class="site-section" id="next-section">
      <div class="container">
       <h1>{{__('Add Educational Information')}}</h1>
       <h3>{{__('Add highest educational information only.')}}</h3>
         @include('includes.val_error')
        @include('includes.message')
        <div class="row">
      
          <div class="col-lg-6 mb-5 mb-lg-0">
            <form action="{{route('educations.store')}}" method="post">@csrf
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" id="program" name="program" class="form-control" value="{{old('program')}}">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" id="board" name="board" class="form-control" value="{{old('subject')}}">
                </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" id="institution" name="institution" class="form-control" value="{{old('board')}}">
                </div>
              </div>
               <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" id="system" name="system" class="form-control" value="{{old('ssystem')}}">
                </div>
