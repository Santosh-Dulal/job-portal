...
<section class="site-section" id="next-section">
      ...
      @include('includes.message')
       ...
       <h1>{{__('Add Reference Information')}}</h1>
        <div class="row">
       
          <div class="col-lg-6 mb-5 mb-lg-0">
            <form action="{{route('references.store')}}" method="post">@csrf
               ...
               <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" id="post" name="post" class="form-control" value="{{old('post')}}" required>
