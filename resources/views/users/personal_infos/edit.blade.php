...
<section class="site-section" id="next-section">
      ...
      @include('includes.message')
       ...
       <h1>{{__('Edit Personal Information')}}</h1>
        <div class="row">
       
          <div class="col-lg-6 mb-5 mb-lg-0">
            <form action="{{route('personalinfos.update',[$info->id])}}" method="post">@csrf @method('patch')
               ...
               <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <input type="subject" id="current_address" name="current_address" class="form-control" value="{{$info->current_address}}" required>
                ...
                <div class="col-md-12">
                  ...
                  <input type="subject" id="permanent_address" name="permanent_address" class="form-control" value="{{$info->permanent_address}}" required>
              ...
              <div class="row form-group">
               <div class="col-md-12">
                  ...
                  <input type="text" id="dob" name="dob" class="form-control" value="{{$info->DoB}}" required>
                ...
                <div class="col-md-12">
                  <label class="text-black" for="subject">Gender*</label>
                      ...
                      <select id="gender" class="form-control" name="gender">
                          ...
                          <option value="female" @if ($info->gender=="femaale") selected @endif>Female</option>
                                <option value="xxxx"{{ ($info->gender=="xxxx") ? "selected":""}}>xxxx</option>
                      </select>
                </div>
              </div>
